...
namespace ToneParsFLExDll
{
	public partial class TracingOptionsDialog : Form
	{
		public TracingOptionsDialog()
		{
			...
			cbMorphemeToneAssignmentTrace.Checked = ToneParsInvokerOptions.Instance.MorphemeToneAssignmentTrace;
		...
		private void btnOK_Click(object sender, EventArgs e)
		{
			...
			ToneParsInvokerOptions.Instance.MorphemeToneAssignmentTrace = cbMorphemeToneAssignmentTrace.Checked;
