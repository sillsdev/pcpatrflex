	...
	public class Preparer
	{
		...
		public void AddPCPATRList()
		{
			...
			NonUndoableUnitOfWorkHelper.Do(Cache.ActionHandlerAccessor, () =>
			{
				...
				{
					CreateNewPcPatrFeaturePossibility(ws, pcpatrList, factPoss, sName);
				}
			});
		}

		private static void CreateNewPcPatrFeaturePossibility(int ws, ICmPossibilityList newList, ICmPossibilityFactory factPoss, string sName)
		{
